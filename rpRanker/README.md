# rpranker -- Rank heterologous pathways according to their global score.

The open-source software package rpranker is available here : https://github.com/brsynth/rptools/tree/master/rptools/rprank

## How to run rpranker wrapper tests

In order to execute tests on rpranker wrapper, you need to:
  ...
  ```bash
  planemo test --conda_channels conda-forge tools/synbiocad-galaxy-wrappers/rpRanker/wrap.xml
  ```
