# Selenzy-wrapper -- Performs enzyme selection from a reaction query.

The open-source software package selenzy-wrapper is available here : https://github.com/brsynth/selenzy-wrapper

## How to run selenzy-wrapper wrapper tests

In order to execute tests on selenzy-wrapper wrapper, you need to:
  ...
  ```bash
  planemo test --conda_channels conda-forge --conda_debug tools/synbiocad-galaxy-wrappers/selenzy-wrapper/wrap.xml
  ```
