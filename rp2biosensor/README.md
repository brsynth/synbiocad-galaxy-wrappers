...
The open-source software package rp2biosensor is available here : https://github.com/brsynth/rp2biosensor

## How to run rp2biosensor wrapper tests

In order to execute tests on rp2biosensor wrapper, you need to:
  ...
  ```bash
  planemo test --conda_channels conda-forge tools/synbiocad-galaxy-wrappers/rp2biosensor/wrap.xml
  ```
