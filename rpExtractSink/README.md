# rpExtractSink -- Generate the RetroPath2.0 sink file from an SBML input.

The open-source software package rpExtractSink is available here : https://github.com/brsynth/rpExtractSink

## How to run rpExtractSink wrapper tests

In order to execute tests on rpExtractSink wrapper, you need to:
