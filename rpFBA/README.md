# rpFBA -- Perform FBA for the RetroPath2.0 heterologous pathways

The open-source software package rpFBA is available here : https://github.com/brsynth/rptools/tree/master/rptools/rpfba

## How to run rpFBA wrapper tests

In order to execute tests on rpFBA wrapper, you need to:
  ...
  ```bash
  planemo test --conda_channels conda-forge --conda_debug tools/BRSynthTools/rpFBA/wrap.xml
  ```
