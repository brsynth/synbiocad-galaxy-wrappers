# Dnaweaver -- Given a SBOL input, calculate assembly parts for Gibson or Golden Gate.

The open-source software package Dnaweaver is available here : https://github.com/brsynth/DNAWeaver_SynBioCAD

## How to run Dnaweaver wrapper tests

In order to execute tests on Dnaweaver wrapper, you need to:
  ...
  ```bash
  planemo test --conda_channels conda-forge tools/synbiocad-galaxy-wrappers/DNAWeaver/wrap.xml
  ```
