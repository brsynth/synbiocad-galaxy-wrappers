...
The open-source software package PartsGenie is available here : https://github.com/neilswainston/PartsGenieClient/

## How to run PartsGenie wrapper tests

In order to execute tests on PartsGenie wrapper, you need to:
  ...
  ```bash
  planemo test --conda_channels conda-forge tools/synbiocad-galaxy-wrappers/PartsGenie/wrap.xml
  ```
